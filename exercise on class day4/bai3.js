...
// 3.1 What is the data type of the outermost layer (Number, String, Object,
//     Array or else)?
//     - is object    

// 3.2 The hits property is where the job results are stored, is it a Number, String,
// Array, Object or something else?
//     - is Array
// 3.3 In each hit of hits, how to find the job’s title, locations, salary, benefits, skills
// and requirements
for(let i=0; i<jobSearch.hits.length;i++)
    {
      console.log("Phan",[i+1])  
      console.log('job Title:',jobSearch.hits[i].jobTitle)
      console.log('salary:',jobSearch.hits[i].jobSalary)
      console.log('benefits:',jobSearch.hits[i].benefits)
